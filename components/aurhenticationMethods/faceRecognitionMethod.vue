      ...
      <v-form v-model="form.valid" :disabled="!selected">
        <div id="faceCam" v-show="showCam">
          ...
          <v-container v-show="cam.open">
            <v-row>
              <v-col>
                <vue-web-cam v-on:started="camStarted"
                             :disabled="!selected" :playsinline="false" :selectFirstDevice="true" ref="webcam" height="185" @error="onError"/>
              </v-col>
            </v-row>
          </v-container>
        </div>
